                ...
                <form method="GET" action="{{ route('kontraktor.index') }}" class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="input-group input-group-sm">
                            <input type="text" name="search" class="form-control"
                                placeholder="Cari nama, penanggung jawab, atau kontak..." value="{{ request('search') }}">
                    ...
                    <div class="col-md-3 text-end">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-secondary" onclick="setViewMode('table')">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    Proyek Terlibat</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $proyekDenganKontraktor ?? 0 }}
                                </div>
                            </div>
                            <div class="col-auto">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        ...
                                        <h6 class="mb-0 fw-bold">
                                            {{ $kontraktor->proyek->nama_proyek ?? 'Tidak Terhubung' }}</h6>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        @if ($kontraktor->kontak_valid)
                                            <a href="tel:{{ $kontraktor->kontak }}" class="text-decoration-none d-block">
                                                <h6 class="mb-0 fw-bold text-success">
                                                    {{ $kontraktor->kontak_formatted ?? $kontraktor->kontak }}</h6>
                                                <small class="text-success"><i class="fas fa-check-circle me-1"></i>Kontak
                                                    Valid</small>
                                            </a>
                                        @else
                                            <div class="d-block">
                                                ...
                                                <small class="text-warning"><i
                                                        class="fas fa-exclamation-triangle me-1"></i>Format Tidak
                                                    Standar</small>
                                            </div>
                                        @endif
                                    </div>
