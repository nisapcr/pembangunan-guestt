...
<a href="{{ route('home') }}" class="navbar-brand d-flex align-items-center">
    <svg class="logo-navbar" width="200" height="60" viewBox="0 0 400 120" xmlns="http://www.w3.org/2000/svg">
        <!-- Icon Container -->
        <g transform="translate(10, 10)">
            ...
            <!-- Tower Crane -->
            <line x1="60" y1="30" x2="60" y2="70" stroke="#FFA726" stroke-width="3" stroke-linecap="round"/>
            <line x1="60" y1="30" x2="80" y2="30" stroke="#FFA726" stroke-width="3" stroke-linecap="round"/>
            <line x1="40" y1="30" x2="60" y2="30" stroke="#FFA726" stroke-width="2.5" stroke-linecap="round"/>

            <!-- Crane Cable -->
            <line x1="70" y1="30" x2="70" y2="45" stroke="#FF6B6B" stroke-width="2" stroke-linecap="round" stroke-dasharray="2,2"/>
        ...
        <!-- Text -->
        <text x="120" y="50" font-family="Arial, sans-serif" font-size="28" font-weight="700" fill="#1E3A5F">
            Pembangunan
        </text>
        <text x="120" y="78" font-family="Arial, sans-serif" font-size="28" font-weight="700" fill="#1E3A5F">
            Proyek
        </text>
    </svg>
</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                ...
                <!-- MENU KONTRAKTOR (Jika ada) -->
                @if(Route::has('kontraktor'))
                <li class="nav-item">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(e) {
        if (!e.target.closest('.nav-item.dropdown')) {
            const openDropdowns = document.querySelectorAll('.nav-item.dropdown .dropdown-toggle[aria-expanded="true"]');
